...
4. Select the `python-backend` folder
...
2. **Backend URL:** `https://your-project-name.railway.app`
...
**Vercel (Frontend):**
- `PYTHON_BACKEND_URL`: Backend Railway URL
...
If you encounter issues, check the deployment logs in Vercel/Railway dashboards.
